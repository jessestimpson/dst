defmodule DstSchedTest do
  @moduledoc """
  Phase 0 exit criteria for `:dst_sched` (see docs/design/dst_framework_design.md).
  ...
  # The scheduler under test is Erlang: src/dst_sched.erl
  @sched :dst_sched
  ...
  defmodule Trace do
    ...
    def new, do: :ets.new(:dst_trace, [:public, :ordered_set])
